...
$COMPRAS = new Movimientos(CurrentUser::getDb());
...
<div class="mt-0 d-none d-md-block">  
    ...
    <button onclick="window.location = '/Dashboard/Salidas'" class="btn btn-outline-primary me-6" type="button">Menu</button>  
</div>
<hr/>
...
<div class='row gx-5 justify-content-center'>
        ...
        <div class='row'>
            <?php
            echo FormsCompras::encabezado($compra, false);
