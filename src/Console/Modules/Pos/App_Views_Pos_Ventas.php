...
$link = ($editar)?"/Dashboard/Devolucion/{FacID}":"";
$formapago = array("value"=>"-1:SELECIONA;01:EFECTIVO;02:CHEQUE;03:TRANFERENCIA;04:TARJETA;08:VALE;28:DEBITO;99:MIXTA;100:PUNTOS");

$ticket ="<a style='color:white !important' class='btn btn-primary box' href='/Dashboard/Imprimir-Venta/{FacID}'>Ticket</a>";
...
$GRID->encabezado("Ventas", "FacFecha", array(
...
$GRID->sql("select distinct FacID, FacID as id, FacDatos, FacFecha,CliNombre,
    ...
    from ventas inner join clientes on FacReceptor = CliID Where $datos->where ", "ventas");
$ventas = $GRID->mostrar();
	...
	$(document).ajaxComplete(function( event,request, settings )
	  {
	  	if(!add_button)
	  	{
  		    ...
  		    {  		       
  		        ...
  		        {
					window.location = "/Dashboard/Venta";
